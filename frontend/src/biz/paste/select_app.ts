...
import { AppSummary, fetchAppList } from "./service";

export function AppSelectViewModel(props: {
  defaultValue: { id: number | string }[];
  disabled?: boolean;
  client: HttpClientCore;
  onLoaded?: (list: AppSummary[]) => void;
}) {
...
export type AppSelectViewModel = ReturnType<typeof AppSelectViewModel>;
